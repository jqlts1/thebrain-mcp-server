# Returns search results from all public brains

**接口路径:** `GET /search/public`
...
| excludeBrainIds | query | Brain IDs to exclude from the search results | 否 | array of string (uuid) | - |
